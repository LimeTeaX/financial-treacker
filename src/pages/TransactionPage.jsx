  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <span
          className={`text-sm font-bold ${tx.amount >= 0 ? "text-emerald-500" : "text-slate-800"}`}
        >
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50/50">
                  {["Merchant", "Category", "Date", "Amount", "Status"].map(
                    (h) => (
                      <th
                        key={h}
                    ...
                    return (
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <span
                              className={`inline-flex h-9 w-9 items-center justify-center rounded-xl ${bg} ${color}`}
                            >
                              <Icon size={16} />
                            </span>
                        ...
                        <td
                          className={`px-6 py-4 text-sm font-bold ${tx.amount >= 0 ? "text-emerald-500" : "text-slate-800"}`}
                        >
                          {formatCurrency(tx.amount)}
                        </td>
                        <td className="px-6 py-4">
          ...
          <div className="bg-white rounded-3xl p-6 w-full max-w-md border border-slate-100 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="flex-1 rounded-xl bg-[#8B5CF6] py-2 text-sm font-medium text-white hover:bg-violet-700 transition-colors"
                >
                  Save
                </button>
              </div>
